  ...
  set_variables:
    ...
    steps:
      ...
      - name: Set variables from JSON
        id: json2vars
        uses: 7rikazhexde/json2vars-setter@v1.11.0
        with:
