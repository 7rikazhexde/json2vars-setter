...
6. **Example project** — `examples/<lang>/`: a small JSON-parser project with source,
   ...
   (cabal), julia (Pkg), ocaml (opam), kotlin (kotlinc CLI, no build file), clang (C++,
