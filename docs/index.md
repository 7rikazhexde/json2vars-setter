...
| [Matrix aggregate output](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/matrix-aggregate) | [![Sample: Matrix Aggregate](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_matrix_aggregate.yml/badge.svg)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_matrix_aggregate.yml) | Consume the `matrix_<lang>` output: assign a whole matrix with **one** `fromJson` and use `${{ matrix.version }}` / `${{ matrix.os }}` — no per-axis `fromJson`, no index access | [![workflow](https://img.shields.io/badge/workflow-2088FF?logo=githubactions&logoColor=white)](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_matrix_aggregate.yml) [![README](https://img.shields.io/badge/README-24292f?logo=github&logoColor=white)](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/matrix-aggregate) |
| [Zero fromJson](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/zero-fromjson) | [![Sample: Zero fromJson](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_zero_fromjson.yml/badge.svg)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_zero_fromjson.yml) | Delegate the matrix + test run to a `workflow_call` library so the **caller writes zero** `fromJson` **and no command** (tests run by convention) — at the cost of delegating the test run | [![workflow](https://img.shields.io/badge/workflow-2088FF?logo=githubactions&logoColor=white)](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_zero_fromjson.yml) [![README](https://img.shields.io/badge/README-24292f?logo=github&logoColor=white)](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/zero-fromjson) |
