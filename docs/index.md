...
|----------|--------|----------------------|-------|
| Single source of truth | [![Sample: Single Source of Truth](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/7rikazhexde/43c16c21c735a80b673a65e1bb0d9619/raw/sample-single-source-badge.json&cacheSeconds=0&style=for-the-badge)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_single_source.yml) | One JSON parsed once, then consumed by an independent `test` matrix **and** a separate `lint` job — define versions in one place, use them everywhere | [workflow](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_single_source.yml) · [example](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase) |
| Monorepo | [![Sample: Monorepo](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/7rikazhexde/f656174a6e80a09b405b7998acadfbbc/raw/sample-monorepo-badge.json&cacheSeconds=0&style=for-the-badge)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_monorepo.yml) | Several projects in one repo, each with its **own** matrix JSON (Python backend + Node.js frontend) and an independent test matrix | [workflow](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_monorepo.yml) · [example](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/monorepo) |
| Template from cache | [![Sample: Template (cache)](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/7rikazhexde/0d505761860b197c29ff8b6ec3c3a0ed/raw/sample-template-badge.json&cacheSeconds=0&style=for-the-badge)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_template.yml) | Generate a matrix from an existing version cache with **no API calls** (`template-only`), trimmed via `output-count` | [workflow](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_template.yml) · [example](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/template) |
| Version cache | [![Sample: Version Cache](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/7rikazhexde/f6745f3939de53fca5fa14ed4030752d/raw/sample-version-cache-badge.json&cacheSeconds=0&style=for-the-badge)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_version_cache.yml) | Drive a multi-version matrix from a committed cache (`use-cache`) — **zero API calls** on a cache hit, auto-refresh when `cache-max-age` is exceeded | [workflow](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_version_cache.yml) · [example](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/version-cache) |
| Dynamic update (scheduled) | [![Sample: Dynamic Update](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/7rikazhexde/d6a3df65bb1dbd6eebf6ca7bdd938d80/raw/sample-dynamic-update-badge.json&cacheSeconds=0&style=for-the-badge)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_dynamic_update.yml) | Weekly scheduled maintenance: fetch the latest language versions from the live API (`update-matrix`) and rebuild the matrix — side-effect-free (no commit) | [workflow](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_dynamic_update.yml) · [example](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/dynamic-update) |
| Conditional matrix | [![Sample: Conditional Matrix](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/7rikazhexde/d3189e6457c55fb9ee6859b4809be195/raw/sample-conditional-matrix-badge.json&cacheSeconds=0&style=for-the-badge)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_conditional_matrix.yml) | Pick the matrix by event — a light, fast matrix on pull requests and the full cross-OS matrix on schedule / dispatch | [workflow](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_conditional_matrix.yml) · [example](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/conditional) |
| Reusable workflow | [![Sample: Reusable Workflow](https://img.shields.io/endpoint?url=https://gist.githubusercontent.com/7rikazhexde/16a9385abb96e85e10de11afab646f8f/raw/sample-reusable-workflow-badge.json&cacheSeconds=0&style=for-the-badge)](https://github.com/7rikazhexde/json2vars-setter/actions/workflows/sample_reusable_workflow.yml) | Define the matrix once in a `workflow_call` library and consume its outputs from a caller — maintain the version set in one place | [workflow](https://github.com/7rikazhexde/json2vars-setter/blob/main/.github/workflows/sample_reusable_workflow.yml) · [example](https://github.com/7rikazhexde/json2vars-setter/tree/main/examples/showcase/reusable) |
